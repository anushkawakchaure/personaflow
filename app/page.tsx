...
export default function DashboardPage() {
  ...
  // Debug log to confirm session data
  console.log("🔍 Selected session:", selectedSession?.id, selectedSession?.visitorId);
              ...
              <div className="flex items-start justify-between">
                <div>
                  <h2 className="text-xl font-semibold text-text-primary">
                    {selectedSession.visitorId || selectedSession.customerName || "Anonymous"} · {selectedSession.id.slice(0, 8)}
                  </h2>
